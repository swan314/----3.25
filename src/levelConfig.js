...
/**
 * 진단 티어별 수련 MATH-CARD 15문항(5×3) 코드.
 * 문제 선택 카드·카드 보관함 슬롯이 동일 기준을 사용합니다.
 */
export const LEVEL_PROBLEM_SETS = {
  하: [
    ['1-A', '1-B', '1-C', '1-D', '1-E'],
    ['2-A', '2-B', '2-C', '2-D', '2-E'],
    ['3-A', '3-B', '3-C', '3-D', '3-E'],
...
/**
 * 티어별 수련 CSV 풀에서 마지막 문항 코드(이후 행 없음).
 * 재입장 시 진단 인트로 생략 여부 판별용 — 데이터와 불일치하면 안 됨.
 */
export const TIER_TERMINAL_TRAINING_PROBLEM_CODE = {
  최상: '6-G',
  상: '5-E',
  중: '4-E',
  하: '3-E',
